...
config-hyprland:
    ...
    cp -r archao-hyprland/assets/backgrounds/* ~/.hypr-assets/backgrounds && cp -r archao-hyprland/assets/wlogout/* ~/.hypr-assets/wlogout && sudo cp -r archao-hyprland/assets/wlogout/* /usr/local/share/wlogout
